...
function Faq() {
    ...
    return (
        <main className="text-container p-4">
            ...
            <p>{t("faq.location")}</p>
            <h2 className="mt-4 mb-2 text-xl font-semibold">{t("faq.calendar-q")}</h2>
            <p>{t("faq.calendar")}</p>
            <h2 className="mt-4 mb-2 text-xl font-semibold">{t("faq.colors-q")}</h2>
            <p>{t("faq.colors")}</p>
            <h2 className="mt-4 mb-2 text-xl font-semibold">{t("faq.creation-q")}</h2>
            <p>{t("faq.creation")}</p>
            <h2 className="mt-4 mb-2 text-xl font-semibold">{t("faq.account-q")}</h2>
            <p>{t("faq.account")}</p>
            <h2 className="mt-4 mb-2 text-xl font-semibold">{t("faq.delete-q")}</h2>
            <p>{t("faq.delete")}</p>
            <h2 className="mt-4 mb-2 text-xl font-semibold">{t("faq.data-security-q")}</h2>
